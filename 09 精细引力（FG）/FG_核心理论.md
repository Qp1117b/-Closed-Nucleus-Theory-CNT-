...
$$\text{GL}(5)\ \text{自守谱} \xrightarrow{\text{紧化投影（表示层转移）}} \text{SU}(5)\ \text{表示空间} \xleftrightarrow{\text{重组实现}} U(1) \times SU(2) \times SU(3)$$
...
$$\boxed{\text{SU}(5) \;\xleftrightarrow{\text{规范重组}}\; U(1) \times SU(2) \times SU(3)}$$
